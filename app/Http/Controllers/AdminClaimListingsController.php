<?php namespace App\Http\Controllers;
	...
	class AdminClaimListingsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Listing Id","name"=>"listing_id"];
			...
			$this->col[] = ["label"=>"Files","name"=>"files"];
			$this->col[] = ["label"=>"Status","name"=>"status",'callback_php' => '($row->status=="Approved")?"<span class=\"label label-success\">Approved</span>":"<span class=\"label label-danger\">Disapproved</span>"'];
			...
			//$this->form[] = ['label'=>'E Mail','name'=>'e_mail','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Verification Details','name'=>'verification_details','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Files','name'=>'files','type'=>'filemanager','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# OLD END FORM
